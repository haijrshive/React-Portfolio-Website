    ...
    <section id='about'>
      ...
      <div className="container about__container">
        ...
        <div className="about__content">
          ...
          <p>
            Hello world! My name is Hai and welcome to my portolio site! Throughout my professional career, I have traversed many fields earning the titles of United States Marine, kinesiologist and Model Bartender in the Las Vegas Nightlife. My journey into coding and software development began in 2020 during quarantine as I self taught through online tutorials. In 2022, I attended a coding bootcamp and graduated as a front end developer. What I love most about coding is that it's a combination of problem solving and learning to be fluent in computer speak. Outside of the tech world,  I am an avid snowboarder, a jiujitsu black belt and frenchie papa.
          </p>
